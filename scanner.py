...
FII_UNIVERSE = [                  # universo amplo e curado de FIIs B3 (tijolo, papel, FoF, hibrido, fiagro)
    ...
    "BRCO11.SA", "TRXF11.SA", "RBRP11.SA", "BBPO11.SA", "PATL11.SA",
    # Tijolo - Logistica / Galpoes
    "HGLG11.SA", "XPLG11.SA", "VILG11.SA", "BTLG11.SA", "LVBI11.SA",
    "GGRC11.SA", "VINO11.SA", "RBRL11.SA", "SDIL11.SA",
    # Tijolo - Shoppings
    "VISC11.SA", "XPML11.SA", "HSML11.SA", "MALL11.SA", "SHPH11.SA",
    "ABCP11.SA",
    # Tijolo - Renda urbana / hibrido / agencias
    "HGRU11.SA", "HGBS11.SA", "TGAR11.SA", "RBVA11.SA", "MFII11.SA",
    # Papel / Recebiveis (CRI)
    "MXRF11.SA", "KNCR11.SA", "KNIP11.SA", "KNSC11.SA", "IRDM11.SA",
    ...
    # Fundo de Fundos (FoF)
    "BCFF11.SA", "HFOF11.SA", "RBRF11.SA", "KFOF11.SA", "MFOF11.SA",
    "XPSF11.SA", "RVBI11.SA", "ALZR11.SA",
    # Fiagro
...
def build_summary_message(compras, pre_compras, vendas, pre_vendas, data_ref) -> str:
    linhas = [f"📊 Sinais do dia (FIIs) — {data_ref}", ""]

    if not (compras or pre_compras or vendas or pre_vendas):
...
def main():
    ...
    data_ref = pd.Timestamp.utcnow().tz_convert("America/Sao_Paulo").strftime("%d/%m/%Y")
    msg = build_summary_message(compras, pre_compras, vendas, pre_vendas, data_ref)
    send_telegram(msg)
