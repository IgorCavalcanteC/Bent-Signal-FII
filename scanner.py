...
PVP_MAX = 0.95      # P/VP abaixo disso = fundo descontado
DY_MIN = 8.5        # Dividend Yield 12m (%) acima disso = rendimento elevado
RSI_VALOR_MAX = 50  # confirmacao tecnica: nao esta em queda livre forte
